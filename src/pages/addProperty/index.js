...
class AddProperty extends Component {
  ...
  render(){
    ...
    return (
      <MainWrapper>
        <CardComponent label='Informacje podstawowe' description='lorem ipsum'>
              <Input
                placeholder={'Tytuł'}
        ...
        <CardComponent label="Lokalizacja" description='lorem ipsum'>
            <Input
              placeholder={'Ulica'}
              onChange={this.handleChange}
          ...
          <CardComponent label="Informacje szczegółowe" description='lorem ipsum'>
                <Input
          ...
          <CardComponent label="Dodatkowe informacje" description='lorem ipsum'>
